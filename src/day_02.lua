local function get_checksum(t)
  ...
  for _, row in ipairs(t) do
    ...
    for _, v in ipairs(row) do
      if r_min == nil or v < r_min then r_min = v end
      if r_max == nil or v > r_max then r_max = v end
    end

    checksum = checksum + (r_max - r_min)
  end
